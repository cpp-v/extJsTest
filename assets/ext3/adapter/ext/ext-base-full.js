...
(function () {
  ...
  Ext.apply(k, {
    ...
    callParent: function (e) {
      var t;
      return (t = this.callParent.caller) && (t.$previous || ((t = t.$owner ? t : t.caller) && t.$owner.superclass.self[t.$name])).apply(this, e || b)
    }
  });
  k.prototype = {
    ...
    callParent: function (t) {
      var N,
      e = (N = this.callParent.caller) && (N.$previous || ((N = N.$owner ? N : N.caller) && N.$owner.superclass[N.$name]));
  ...
  Ext.apply(Ext, {
    ...
    extend: function () {
      ...
      return function (S, P, R) {
        if (typeof P == 'object') {
          R = P;
          P = S;
          S = R.constructor != e ? R.constructor : function () {
    ...
    urlEncode: function (Q, P) {
      ...
      Ext.iterate(Q, function (e, R) {
        ...
        Ext.each(N ? e : R, function (S) {
          t.push('&', O(e), '=', (!Ext.isEmpty(S) && (S != e || !N)) ? (Ext.isDate(S) ? Ext.encode(S).replace(/"/g, '')  : O(S))  : '')
        })
      });
      if (!P) {
        t.shift();
    ...
    removeNode: j && !E ? function () {
      var e;
      return function (t) {
        if (t && t.tagName != 'BODY') {
          (Ext.enableNestedListenerRemoval) ? Ext.EventManager.purgeElement(t, true)  : Ext.EventManager.removeAll(t);
    ...
    isEmpty: function (t, e) {
      return t === null || t === undefined || ((Ext.isArray(t) && !t.length)) || (!e ? t === '' : false)
    },
    isArray: function (e) {
...
Ext.util.TaskRunner = function (e) {
  ...
  i = function () {
    ...
    for (var p = 0, o, k, m, j = f.length; p < j; ++p) {
      ...
      k = n - o.taskRunTime;
      if (o.interval <= k) {
        m = o.run.apply(o.scope || o, o.args || [
          ++o.taskRunCount
        ]);
        o.taskRunTime = n;
  ...
  function c(d) {
    ...
    Ext.lib.Dom = {
      ...
      getViewportHeight: function () {
        return Ext.isIE9m ? (Ext.isStrict ? g.documentElement.clientHeight : g.body.clientHeight)  : self.innerHeight
      },
      getViewportWidth: function () {
        return !Ext.isStrict && !Ext.isOpera ? g.body.clientWidth : Ext.isIE9m ? g.documentElement.clientWidth : self.innerWidth
      },
      getY: function (i) {
