...
Ext.DomQuery = function () {
  ...
  return {
    ...
    is: function (el, ss) {
      ...
      result = Ext.DomQuery.filter(isArray ? el : [
        el
      ], ss);
  ...
  function j() {
    if (!Ext.enableGarbageCollector) {
      ...
      for (l in a) {
        p = a[l];
        if (p.skipGC) {
          Ext.EventManager.removeFromSpecialCache(p.el);
          continue
        }
        n = p.el;
        q = n.dom;
...
Ext.Element.addMethods(function () {
  ...
  return {
    ...
    getHeight: function (H) {
      var G = this,
      J = G.dom,
      I = Ext.isIE9m && G.isStyle('display', 'none'),
    ...
    getWidth: function (G) {
      var H = this,
      J = H.dom,
      I = Ext.isIE9m && H.isStyle('display', 'none'),
...
(function () {
  ...
  Ext.Element.addMethods({
    ...
    setX: function (l, m) {
      return this.setXY([l,
      this.getY()], this.animTest(arguments, m, 1))
    },
    setY: function (m, l) {
      return this.setXY([this.getX(),
      m], this.animTest(arguments, l, 1))
    },
    setLeft: function (l) {
...
}; Ext.CompositeElementLite.prototype.on = Ext.CompositeElementLite.prototype.addListener; Ext.CompositeElementLite.importElementMethods = function () {
  var c,
...
}; Ext.CompositeElementLite.importElementMethods(); if (Ext.DomQuery) {
  ...
  Ext.extend(Ext.data.Connection, Ext.util.Observable, {
    ...
    request: function (n) {
      ...
      if (s.fireEvent(b, s, n)) {
        ...
        n.headers = Ext.applyIf(n.headers || {
        }, s.defaultHeaders || {
        });
    ...
    doFormUpload: function (q, j, k) {
      ...
      function s() {
        ...
        try {
          ...
          if (A) {
            if (A.body) {
              if (/textarea/i.test((z = A.body.firstChild || {
              }).tagName)) {
...
Ext.EventManager = function () {
  ...
  p,
  j = false,
  l = Ext.isGecko || Ext.isWebKit || Ext.isSafari || Ext.isIE10p,
  o = Ext.lib.Event,
  q = Ext.lib.Dom,
  c = document,
  A = window,
  ...
  function w(D, E, C) {
    return function (F) {
      C.delay(E.buffer, D, null, [
        new Ext.EventObjectImpl(F)
      ])
    }
  }
  ...
  function e(D, E, C) {
    return function (G) {
      ...
      C.tasks.push(F);
      F.delay(E.delay || 10, D, null, [
        new Ext.EventObjectImpl(G)
      ])
    }
  }
  ...
  var v = {
    ...
    removeFromSpecialCache: function (E) {
      var D = 0,
      C = u.length;
      for (; D < C; ++D) {
        if (u[D].el == E) {
  ...
  var a = function () {
    ...
    if (Ext.isIE) {
      ...
      if (Ext.isIE6) {
        ...
        if (Ext.isIE7) {
          b.push('ext-ie7', 'ext-ie7m')
        } else {
          if (Ext.isIE8) {
            b.push('ext-ie8', 'ext-ie8m')
          } else {
            if (Ext.isIE9) {
              b.push('ext-ie9', 'ext-ie9m')
            } else {
              if (Ext.isIE10) {
                b.push('ext-ie10')
              }
...
function a(h) {
  ...
  if (i.loadScripts) {
    i.renderer.render(i.el, h, i, g.createDelegate(i, [
      h
    ]))
  } else {
...
Ext.apply(Date, {
  ...
  formatCodes: {
    ...
    c: function () {
      for (var k = 'Y-m-dTH:i:sP', h = [
      ], g = 0, d = k.length; g < d; ++g) {
        var j = k.charAt(g);
  ...
  parseCodes: {
    ...
    D: function () {
      for (var c = [
      ], d = 0; d < 7; c.push(Date.getShortDayName(d)), ++d) {
      }
      return {
        g: 0,
        c: null,
    ...
    M: function () {
      for (var c = [
      ], d = 0; d < 12; c.push(Date.getShortMonthName(d)), ++d) {
      }
      return Ext.applyIf({
        s: '(' + c.join('|') + ')'
      }, a('F'))
...
render: function (b, a) {
  if (!this.rendered && this.fireEvent('beforerender', this) !== false) {
    ...
    if (this.contentEl) {
      ...
      Ext.fly(d).removeClass(['x-hidden',
      'x-hide-display']);
      c.appendChild(d)
    }
    if (this.tpl) {
...
a = Ext.isIE9m ? '<div class="x-ie-shadow"></div>' : '<div class="x-shadow"><div class="xst"><div class="xstl"></div><div class="xstc"></div><div class="xstr"></div></div><div class="xsc"><div class="xsml"></div><div class="xsmc"></div><div class="xsmr"></div></div><div class="xsb"><div class="xsbl"></div><div class="xsbc"></div><div class="xsbr"></div></div></div>';
return {
  pull: function () {
    var c = b.shift();
    if (!c) {
...
getLayoutTargetSize: function () {
  ...
  if (b) {
    a = b.getViewSize();
    if (Ext.isIE9m && Ext.isStrict && a.width == 0) {
      a = b.getStyleSize()
    }
...
onLayout: function (e, k) {
  ...
  this.renderAll(e, k);
  var r = this.getLayoutTargetSize();
  if (Ext.isIE9m && (r.width < 1 && r.height < 1)) {
    return
  }
...
getExpandAdj: function () {
  ...
  switch (this.position) {
    case 'west':
      return [ - (a.right + b.getWidth() + a.left),
      0];
      break;
    case 'east':
      return [a.right + b.getWidth() + a.left,
...
adjustWidthAnchor: function (a, d) {
  if (d.label && !this.isHide(d) && (this.container.labelAlign != 'top')) {
    var b = Ext.isIE6 || Ext.isIEQuirks;
...
}); Ext.Container.LAYOUTS.hbox = Ext.layout.HBoxLayout; Ext.layout.VBoxLayout = Ext.extend(Ext.layout.BoxLayout, {
align: 'left',
type: 'vbox',
...
}); Ext.Container.LAYOUTS.vbox = Ext.layout.VBoxLayout; Ext.layout.ToolbarLayout = Ext.extend(Ext.layout.ContainerLayout, {
monitorResize: true,
type: 'toolbar',
triggerWidth: 18,
noItemsMenuText: '<div class="x-toolbar-no-items">(None)</div>',
...
}); Ext.Container.LAYOUTS.toolbar = Ext.layout.ToolbarLayout; Ext.layout.MenuLayout = Ext.extend(Ext.layout.ContainerLayout, {
monitorResize: true,
type: 'menu',
setContainer: function (a) {
...
}); Ext.Container.LAYOUTS.menu = Ext.layout.MenuLayout; Ext.Viewport = Ext.extend(Ext.Container, {
initComponent: function () {
...
}); Ext.reg('viewport', Ext.Viewport); Ext.Panel = Ext.extend(Ext.Container, {
baseCls: 'x-panel',
  ...
  if (Ext.isDefined(a) || Ext.isDefined(b)) {
    if (!this.collapsed) {
      ...
      if (this.footer) {
        ...
        if (this.fbar) {
          this.fbar.setSize(Ext.isIE9m ? (a - this.footer.getFrameWidth('lr'))  : 'auto')
        }
      }
      if (Ext.isNumber(b)) {
...
}); Ext.reg('panel', Ext.Panel); Ext.Editor = function (b, a) {
if (b.field) {
...
onRender: function (b, a) {
  ...
  if (this.swallowKeys) {
    this.field.el.swallowEvent(['keypress',
    'keydown'])
  }
},
...
}); Ext.reg('editor', Ext.Editor); Ext.ColorPalette = Ext.extend(Ext.Component, {
...
onRender: function (b, a) {
  ...
  var c = this.tpl || new Ext.XTemplate('<tpl for="."><a href="#" class="color-{.}" hidefocus="on"><em><span style="background:#{.}" class="x-unselectable" unselectable="on">&#160;</span></em></a></tpl>');
...
}); Ext.reg('colorpalette', Ext.ColorPalette); Ext.DatePicker = Ext.extend(Ext.BoxComponent, {
todayText: 'Today',
okText: '&#160;OK&#160;',
cancelText: 'Cancel',
todayTip: '{0} (Spacebar)',
...
}); Ext.reg('datepicker', Ext.DatePicker); Ext.LoadMask = function (c, b) {
this.el = Ext.get(c);
Ext.apply(this, b);
if (this.store) {
  this.store.on({
...
}); Ext.reg('multislider', Ext.slider.MultiSlider); Ext.slider.SingleSlider = Ext.extend(Ext.slider.MultiSlider, {
constructor: function (a) {
  a = a || {
  };
  Ext.applyIf(a, {
...
}); Ext.Slider = Ext.slider.SingleSlider; Ext.reg('slider', Ext.slider.SingleSlider); Ext.slider.Vertical = {
...
Ext.dd.DragDropMgr = function () {
  ...
  return {
    ...
    fireEvents: function (o, r) {
      ...
      for (j in q.dragOvers) {
        c = q.dragOvers[j];
        if (!q.isTypeOfDD(c)) {
          continue
        }
        if (!this.isOverTarget(s, c, q.mode)) {
          h.push(c)
        }
        b[j] = true;
        delete q.dragOvers[j]
      }
      for (t in l.groups) {
        if ('string' != typeof t) {
          continue
        ...
        for (j in q.ids[t]) {
          c = q.ids[t][j];
          if (q.isTypeOfDD(c) && (u = c.getEl()) && (c.isTarget) && (!c.isLocked()) && ((c != l) || (l.ignoreSelf === false))) {
            if ((c.zIndex = q.getZIndex(u)) !== - 1) {
              p = true
            }
            g.push(c)
          }
      ...
      for (j = 0, n = g.length; j < n; j++) {
        c = g[j];
        if (q.isOverTarget(s, c, q.mode)) {
          if (r) {
            k.push(c)
          } else {
            if (!b[c.id]) {
      ...
      if (q.mode) {
        ...
        for (j = 0, n = h.length; j < n; ++j) {
          l.b4DragOut(o, h[j].id);
          l.onDragOut(o, h[j].id)
        }
        for (j = 0, n = d.length; j < n; ++j) {
          l.onDragEnter(o, d[j].id)
        }
        for (j = 0, n = m.length; j < n; ++j) {
          l.b4DragOver(o, m[j].id);
          l.onDragOver(o, m[j].id)
        }
        for (j = 0, n = k.length; j < n; ++j) {
          l.b4DragDrop(o, k[j].id);
          l.onDragDrop(o, k[j].id)
        }
      }
      if (r && !k.length) {
        l.onInvalidDrop(o)
...
}; Ext.dd.DDProxy.dragElId = 'ygddfdiv'; Ext.extend(Ext.dd.DDProxy, Ext.dd.DD, {
resizeFrame: true,
centerFrame: false,
...
onMouseMove: function (g, d) {
  var b = Ext.isIE6 || Ext.isIE7 || Ext.isIE8;
  if (this.active && b && !g.browserEvent.button) {
    g.preventDefault();
    this.onMouseUp(g);
    return
  }
...
return c
}; Ext.data.Record.PREFIX = 'ext-record'; Ext.data.Record.AUTO_ID = 1; Ext.data.Record.EDIT = 'edit'; Ext.data.Record.REJECT = 'reject'; Ext.data.Record.COMMIT = 'commit'; Ext.data.Record.id = function (a) {
a.phantom = true;
return [Ext.data.Record.PREFIX,
'-',
Ext.data.Record.AUTO_ID++].join('')
...
var b = [
].concat(this.getModifiedRecords());
if (b.length) {
var g = [
];
...
b = (b instanceof Ext.data.Record) ? [
b
] : [
].concat(b);
for (var c = 0, a = b.length; c < a; c++) {
...
}); Ext.reg('store', Ext.data.Store); Ext.data.Store.Error = Ext.extend(Ext.Error, {
name: 'Ext.data.Store'
...
}); Ext.apply(Ext.data.DataProxy, Ext.util.Observable.prototype); Ext.util.Observable.call(Ext.data.DataProxy); Ext.data.DataProxy.Error = Ext.extend(Ext.Error, {
constructor: function (b, a) {
this.arg = a;
Ext.Error.call(this, b)
},
...
}; Ext.data.ScriptTagProxy.TRANS_ID = 1000; Ext.extend(Ext.data.ScriptTagProxy, Ext.data.DataProxy, {
timeout: 30000,
...
if (g == Ext.data.Api.actions.read && this.activeRequest[g]) {
  Ext.Ajax.abort(this.activeRequest[g])
}
...
}); Ext.reg('arraystore', Ext.data.ArrayStore); Ext.data.SimpleStore = Ext.data.ArrayStore; Ext.reg('simplestore', Ext.data.SimpleStore); Ext.data.JsonStore = Ext.extend(Ext.data.Store, {
constructor: function (a) {
Ext.data.JsonStore.superclass.constructor.call(this, Ext.apply(a, {
reader: new Ext.data.JsonReader(a)
}))
}
}); Ext.reg('jsonstore', Ext.data.JsonStore); Ext.data.XmlWriter = function (a) {
...
}); Ext.reg('xmlstore', Ext.data.XmlStore); Ext.data.GroupingStore = Ext.extend(Ext.data.Store, {
...
}); Ext.reg('groupingstore', Ext.data.GroupingStore); Ext.data.DirectProxy = function (a) {
Ext.apply(this, a);
...
}); Ext.reg('directstore', Ext.data.DirectStore); Ext.Direct = Ext.extend(Ext.util.Observable, {
exceptions: {
TRANSPORT: 'xhr',
PARSE: 'parse',
LOGIN: 'login',
...
}); Ext.Direct = new Ext.Direct(); Ext.Direct.TID = 1; Ext.Direct.PROVIDERS = {
...
}); Ext.Direct.PROVIDERS.polling = Ext.direct.PollingProvider; Ext.direct.RemotingProvider = Ext.extend(Ext.direct.JsonProvider, {
enableBuffer: 10,
maxRetries: 1,
timeout: undefined,
constructor: function (a) {
...
}); Ext.Direct.PROVIDERS.remoting = Ext.direct.RemotingProvider; Ext.Resizable = Ext.extend(Ext.util.Observable, {
...
this.position = g;
this.rz = d;
this.el = this.tpl.append(d.el.dom, [
this.position
], true);
this.el.unselectable();
if (e) {
...
u.hide();
w();
Ext.callback(b.fn, b.scope || window, [
x,
v.dom.value,
b
], 1)
...
}); Ext.DataView.prototype.setStore = Ext.DataView.prototype.bindStore; Ext.reg('dataview', Ext.DataView); Ext.list.ListView = Ext.extend(Ext.DataView, {
itemSelector: 'dl',
...
if (!this.internalTpl) {
this.internalTpl = new Ext.XTemplate('<div class="x-list-header"><div class="x-list-header-inner">', '<tpl for="columns">', '<div style="width:{[values.width*100]}%;text-align:{align};"><em class="x-unselectable" unselectable="on" id="', this.id, '-xlhd-{#}">', '{header}', '</em></div>', '</tpl>', '<div class="x-clear"></div>', '</div></div>', '<div class="x-list-body"><div class="x-list-body-inner">', '</div></div>')
}
if (!this.tpl) {
...
}); Ext.reg('listview', Ext.list.ListView); Ext.ListView = Ext.list.ListView; Ext.list.Column = Ext.extend(Object, {
isColumn: true,
align: 'left',
header: '',
width: null,
...
}); Ext.reg('lvcolumn', Ext.list.Column); Ext.list.NumberColumn = Ext.extend(Ext.list.Column, {
format: '0,000.00',
constructor: function (a) {
...
}); Ext.reg('lvnumbercolumn', Ext.list.NumberColumn); Ext.list.DateColumn = Ext.extend(Ext.list.Column, {
format: 'm/d/Y',
constructor: function (a) {
...
}); Ext.reg('lvdatecolumn', Ext.list.DateColumn); Ext.list.BooleanColumn = Ext.extend(Ext.list.Column, {
trueText: 'true',
falseText: 'false',
undefinedText: '&#160;',
...
}); Ext.reg('lvbooleancolumn', Ext.list.BooleanColumn); Ext.list.ColumnResizer = Ext.extend(Ext.util.Observable, {
minPct: 0.05,
constructor: function (a) {
Ext.apply(this, a);
...
}); Ext.ListView.ColumnResizer = Ext.list.ColumnResizer; Ext.list.Sorter = Ext.extend(Ext.util.Observable, {
sortClasses: [
'sort-asc',
'sort-desc'
],
...
this.updateSortState.defer(10, this, [
a.store
])
},
...
}); Ext.ListView.Sorter = Ext.list.Sorter; Ext.TabPanel = Ext.extend(Ext.Panel, {
deferredRender: true,
tabWidth: 120,
minTabWidth: 30,
resizeTabs: false,
...
}); Ext.reg('tabpanel', Ext.TabPanel); Ext.TabPanel.prototype.activate = Ext.TabPanel.prototype.setActiveTab; Ext.TabPanel.AccessStack = function () {
var a = [
];
return {
add: function (b) {
...
Ext.Button.buttonTemplate = new Ext.Template('<table id="{4}" cellspacing="0" class="x-btn {3}"><tbody class="{1}">', '<tr><td class="x-btn-tl"><i>&#160;</i></td><td class="x-btn-tc"></td><td class="x-btn-tr"><i>&#160;</i></td></tr>', '<tr><td class="x-btn-ml"><i>&#160;</i></td><td class="x-btn-mc"><em class="{2} x-unselectable" unselectable="on"><button type="{0}"></button></em></td><td class="x-btn-mr"><i>&#160;</i></td></tr>', '<tr><td class="x-btn-bl"><i>&#160;</i></td><td class="x-btn-bc"></td><td class="x-btn-br"><i>&#160;</i></td></tr>', '</tbody></table>');
...
}); Ext.reg('button', Ext.Button); Ext.ButtonToggleMgr = function () {
var a = {
};
function b(e, j) {
if (j) {
...
}); Ext.reg('splitbutton', Ext.SplitButton); Ext.CycleButton = Ext.extend(Ext.SplitButton, {
...
}); Ext.reg('cycle', Ext.CycleButton); Ext.Toolbar = function (a) {
if (Ext.isArray(a)) {
a = {
items: a,
layout: 'toolbar'
...
}) (); Ext.reg('paging', Ext.PagingToolbar); Ext.History = (function () {
var e,
c;
var k = false;
var d;
...
}) (); Ext.apply(Ext.History, new Ext.util.Observable()); Ext.Tip = Ext.extend(Ext.Panel, {
minWidth: 40,
maxWidth: 300,
shadow: 'sides',
defaultAlign: 'tl-bl?',
...
}); Ext.reg('tip', Ext.Tip); Ext.Tip.DD = function (b, a) {
Ext.apply(this, a);
this.tip = b;
...
}); Ext.tree.TreePanel.nodeTypes.node = Ext.tree.TreeNode; Ext.tree.AsyncTreeNode = function (a) {
...
if (a) {
a.load(this, this.loadComplete.createDelegate(this, [
b,
e,
h,
c
...
}); Ext.tree.TreePanel.nodeTypes.async = Ext.tree.AsyncTreeNode; Ext.tree.TreeNodeUI = Ext.extend(Object, {
constructor: function (a) {
Ext.apply(this, {
node: a,
rendered: false,
...
var n = k[i],
l = j[i],
q = d ? d(n, o)  : (b ? n : n.toUpperCase()),
p = d ? d(l, m)  : (b ? l : l.toUpperCase());
if (q < p) {
return e ? 1 : - 1
} else {
if (q > p) {
...
}); Ext.FlashComponent.EXPRESS_INSTALL_URL = 'http://swfobject.googlecode.com/svn/trunk/swfobject/expressInstall.swf'; Ext.reg('flash', Ext.FlashComponent); Ext.FlashEventProxy = {
onEvent: function (c, b) {
var a = Ext.getCmp(c);
if (a) {
a.onFlashEvent(b)
} else {
arguments.callee.defer(10, this, [
c,
b
])
}
...
}); Ext.reg('chart', Ext.chart.Chart); Ext.chart.Chart.PROXY_FN_ID = 0; Ext.chart.Chart.proxyFunction = {
}; Ext.chart.Chart.CHART_URL = 'http://yui.yahooapis.com/2.8.2/build/charts/assets/charts.swf'; Ext.chart.PieChart = Ext.extend(Ext.chart.Chart, {
type: 'pie',
...
}); Ext.reg('piechart', Ext.chart.PieChart); Ext.chart.CartesianChart = Ext.extend(Ext.chart.Chart, {
onSwfReady: function (a) {
...
}); Ext.reg('cartesianchart', Ext.chart.CartesianChart); Ext.chart.LineChart = Ext.extend(Ext.chart.CartesianChart, {
type: 'line'
}); Ext.reg('linechart', Ext.chart.LineChart); Ext.chart.ColumnChart = Ext.extend(Ext.chart.CartesianChart, {
type: 'column'
}); Ext.reg('columnchart', Ext.chart.ColumnChart); Ext.chart.StackedColumnChart = Ext.extend(Ext.chart.CartesianChart, {
type: 'stackcolumn'
}); Ext.reg('stackedcolumnchart', Ext.chart.StackedColumnChart); Ext.chart.BarChart = Ext.extend(Ext.chart.CartesianChart, {
type: 'bar'
}); Ext.reg('barchart', Ext.chart.BarChart); Ext.chart.StackedBarChart = Ext.extend(Ext.chart.CartesianChart, {
type: 'stackbar'
}); Ext.reg('stackedbarchart', Ext.chart.StackedBarChart); Ext.chart.Axis = function (a) {
Ext.apply(this, a)
...
c = Ext.fly(b).is('.x-menu-scroller-top');
if (c ? a.scrollTop > 0 : a.scrollTop + this.activeMax < a.scrollHeight) {
Ext.fly(b).addClass(['x-menu-item-active',
'x-menu-scroller-active'])
}
},
onScrollerOut: function (b, a) {
Ext.fly(a).removeClass(['x-menu-item-active',
'x-menu-scroller-active'])
},
show: function (b, c, a) {
if (this.floating) {
...
b = [
this.el.adjustForConstraints(b) [0],
b[1]
]
} else {
...
}); Ext.reg('menu', Ext.menu.Menu); Ext.menu.MenuNav = Ext.extend(Ext.KeyNav, function () {
function a(d, c) {
...
if (this.hideOnClick) {
if (a.floating) {
this.clickHideDelayTimer = a.hide.defer(this.clickHideDelay, a, [
true
])
} else {
a.deactivateActive()
...
}); Ext.reg('menubaseitem', Ext.menu.BaseItem); Ext.menu.TextItem = Ext.extend(Ext.menu.BaseItem, {
hideOnClick: false,
itemCls: 'x-menu-text',
constructor: function (a) {
if (typeof a == 'string') {
...
}); Ext.reg('menutextitem', Ext.menu.TextItem); Ext.menu.Separator = Ext.extend(Ext.menu.BaseItem, {
itemCls: 'x-menu-sep',
hideOnClick: false,
activeClass: '',
onRender: function (a) {
...
}); Ext.reg('menuseparator', Ext.menu.Separator); Ext.menu.Item = Ext.extend(Ext.menu.BaseItem, {
itemCls: 'x-menu-item',
canActivate: true,
showDelay: 200,
altText: '',
...
if (!this.itemTpl) {
this.itemTpl = Ext.menu.Item.prototype.itemTpl = new Ext.XTemplate('<a id="{id}" class="{cls} x-unselectable" hidefocus="true" unselectable="on" href="{href}"', '<tpl if="hrefTarget">', ' target="{hrefTarget}"', '</tpl>', '>', '<img alt="{altText}" src="{icon}" class="x-menu-item-icon {iconCls}"/>', '<span class="x-menu-item-text">{text}</span>', '</a>')
}
...
}); Ext.reg('menuitem', Ext.menu.Item); Ext.menu.CheckItem = Ext.extend(Ext.menu.Item, {
...
}); Ext.reg('menucheckitem', Ext.menu.CheckItem); Ext.menu.DateMenu = Ext.extend(Ext.menu.Menu, {
...
}); Ext.reg('datemenu', Ext.menu.DateMenu); Ext.menu.ColorMenu = Ext.extend(Ext.menu.Menu, {
enableScrolling: false,
hideOnClick: true,
cls: 'x-color-menu',
paletteId: null,
...
}); Ext.reg('colormenu', Ext.menu.ColorMenu); Ext.form.Field = Ext.extend(Ext.BoxComponent, {
...
}; Ext.reg('field', Ext.form.Field); Ext.form.TextField = Ext.extend(Ext.form.Field, {
grow: false,
growMin: 30,
growMax: 800,
vtype: null,
...
}); Ext.reg('textfield', Ext.form.TextField); Ext.form.TriggerField = Ext.extend(Ext.form.TextField, {
defaultAutoCreate: {
tag: 'input',
type: 'text',
size: '16',
...
}); Ext.reg('trigger', Ext.form.TriggerField); Ext.reg('twintrigger', Ext.form.TwinTriggerField); Ext.form.TextArea = Ext.extend(Ext.form.TextField, {
growMin: 60,
growMax: 1000,
growAppend: '&#160;\n&#160;',
...
}); Ext.reg('textarea', Ext.form.TextArea); Ext.form.NumberField = Ext.extend(Ext.form.TextField, {
...
}); Ext.reg('numberfield', Ext.form.NumberField); Ext.form.DateField = Ext.extend(Ext.form.TriggerField, {
format: 'm/d/Y',
...
}); Ext.reg('datefield', Ext.form.DateField); Ext.form.DisplayField = Ext.extend(Ext.form.Field, {
...
}); Ext.reg('displayfield', Ext.form.DisplayField); Ext.form.ComboBox = Ext.extend(Ext.form.TriggerField, {
defaultAutoCreate: {
tag: 'input',
type: 'text',
size: '24',
...
}); Ext.reg('combo', Ext.form.ComboBox); Ext.form.Checkbox = Ext.extend(Ext.form.Field, {
...
}); Ext.reg('checkbox', Ext.form.Checkbox); Ext.form.CheckboxGroup = Ext.extend(Ext.form.Field, {
columns: 'auto',
vertical: false,
allowBlank: true,
...
initValue: function () {
if (this.value) {
this.setValue.apply(this, this.buffered ? this.value : [
this.value
]);
...
}); Ext.reg('checkboxgroup', Ext.form.CheckboxGroup); Ext.form.CompositeField = Ext.extend(Ext.form.Field, {
...
Ext.apply(e, {
  markInvalid: this.onFieldMarkInvalid.createDelegate(this, [
    e
  ], 0),
  clearInvalid: this.onFieldClearInvalid.createDelegate(this, [
    e
  ], 0)
})
})
...
}); Ext.reg('compositefield', Ext.form.CompositeField); Ext.form.Radio = Ext.extend(Ext.form.Checkbox, {
inputType: 'radio',
markInvalid: Ext.emptyFn,
clearInvalid: Ext.emptyFn,
...
}); Ext.reg('radio', Ext.form.Radio); Ext.form.RadioGroup = Ext.extend(Ext.form.CheckboxGroup, {
allowBlank: true,
...
}); Ext.reg('radiogroup', Ext.form.RadioGroup); Ext.form.Hidden = Ext.extend(Ext.form.Field, {
inputType: 'hidden',
shouldLayout: false,
onRender: function () {
...
markInvalid: Ext.emptyFn,
clearInvalid: Ext.emptyFn
}); Ext.reg('hidden', Ext.form.Hidden); Ext.form.BasicForm = Ext.extend(Ext.util.Observable, {
constructor: function (b, a) {
Ext.apply(this, a);
if (Ext.isString(this.paramOrder)) {
this.paramOrder = this.paramOrder.split(/[\s,|]/)
...
Ext.callback(b.success, b.scope, [
this,
a
]);
this.fireEvent('actioncomplete', this, a)
} else {
Ext.callback(b.failure, b.scope, [
this,
a
]);
...
}); Ext.BasicForm = Ext.form.BasicForm; Ext.FormPanel = Ext.extend(Ext.Panel, {
minButtonWidth: 75,
labelAlign: 'left',
monitorValid: false,
monitorPoll: 200,
...
}); Ext.reg('form', Ext.FormPanel); Ext.form.FormPanel = Ext.FormPanel; Ext.form.FieldSet = Ext.extend(Ext.Panel, {
baseCls: 'x-fieldset',
layout: 'form',
animCollapse: false,
onRender: function (b, a) {
...
}); Ext.reg('fieldset', Ext.form.FieldSet); Ext.form.HtmlEditor = Ext.extend(Ext.form.Field, {
enableFormat: true,
enableFontSize: true,
enableColors: true,
...
a.open();
a.write(this.getDocMarkup());
a.close();
this.readyTask = {
run: function () {
var b = this.getDoc();
if (b.body || b.readyState == 'complete') {
...
Ext.destroy(this.tb);
var b = this.getDoc();
Ext.EventManager.removeFromSpecialCache(b);
if (b) {
try {
...
}); Ext.reg('htmleditor', Ext.form.HtmlEditor); Ext.form.TimeField = Ext.extend(Ext.form.ComboBox, {
minValue: undefined,
maxValue: undefined,
...
}); Ext.reg('timefield', Ext.form.TimeField); Ext.form.SliderField = Ext.extend(Ext.form.Field, {
useTips: true,
tipText: null,
actionMode: 'wrap',
initComponent: function () {
...
}); Ext.reg('sliderfield', Ext.form.SliderField); Ext.form.Label = Ext.extend(Ext.BoxComponent, {
onRender: function (b, a) {
if (!this.el) {
...
}); Ext.reg('label', Ext.form.Label); Ext.form.Action = function (b, a) {
this.form = b;
this.options = a || {
}
}; Ext.form.Action.CLIENT_INVALID = 'client'; Ext.form.Action.SERVER_INVALID = 'server'; Ext.form.Action.CONNECT_FAILURE = 'connect'; Ext.form.Action.LOAD_FAILURE = 'load'; Ext.form.Action.prototype = {
type: 'default',
run: function (a) {
},
success: function (a) {
...
var a = this.selModel.getCount ? this.selModel.getCount()  : 1;
return String.format(this.ddText, a, a == 1 ? '' : 's')
}
}); Ext.reg('grid', Ext.grid.GridPanel); Ext.grid.PivotGrid = Ext.extend(Ext.grid.GridPanel, {
aggregator: 'sum',
renderer: undefined,
initComponent: function () {
...
}); Ext.reg('pivotgrid', Ext.grid.PivotGrid); Ext.grid.PivotAggregatorMgr = new Ext.AbstractManager(); Ext.grid.PivotAggregatorMgr.registerType('sum', function (a, c) {
var e = a.length,
d = 0,
b;
for (b = 0; b < e; b++) {
...
cellTpl: new Ext.Template('<td class="x-grid3-col x-grid3-cell x-grid3-td-{id} {css}" style="{style}" tabIndex="0" {cellAttr}>', '<div class="x-grid3-cell-inner x-grid3-col-{id} x-unselectable" unselectable="on" {attr}>{value}</div>', '</td>'),
...
if (c && (!Ext.isIE9m || !b.within(c, true))) {
...
if (!a.gcell) {
a.gcell = new Ext.XTemplate('<td class="x-grid3-hd x-grid3-gcell x-grid3-td-{id} ux-grid-hd-group-row-{row} ' + this.colHeaderCellCls + '" style="{style}">', '<div {tooltip} class="x-grid3-hd-inner x-grid3-hd-{id} x-unselectable" unselectable="on" style="{istyle}">', this.grid.enableHdMenu ? '<a class="x-grid3-hd-btn" href="#"></a>' : '', '{value}', '</div>', '</td>')
}
this.templates = a;
...
var c = Ext.lib.Event.getTarget(g),
i,
h = this.view.findRowIndex(c),
b,
a,
d;
if (h !== false) {
i = this.grid.selModel;
if (i.getSelectedCell) {
b = this.view.findCellIndex(c);
a = i.getSelectedCell();
if (!a || a[0] !== h || a[1] !== b) {
i.handleMouseDown(this.grid, h, b, g)
}
...
d = [
this.grid.store.getAt(h)
]
}
} else {
if (!i.isSelected(h) || g.hasModifier()) {
i.handleMouseDown(this.grid, h, g)
}
d = i.getSelections()
}
return {
...
this.getGridEl().on('mousewheel', this.stopEditing.createDelegate(this, [
true
]), this);
...
canceledit: this.stopEditing.createDelegate(this, [
true
])
})
}
...
setupCheckbox: function (c) {
var b = this,
a = function () {
c.el.on('click', b.onCheckClick, b, {
single: true
})
};
if (c.rendered) {
